  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem", marginBottom: "44px" }}>
        ...
        <button
          ...
          onClick={() => alert("Google OAuth – Hafta 2'de aktif olacak")}
        >
        ...
        <button
          ...
          onClick={() => alert("E-posta girişi – Hafta 2'de aktif olacak")}
        >
          Giris Yap
        </button>
